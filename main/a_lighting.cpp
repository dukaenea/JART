...
void renderWithJulia(float scale, const char* filename){
    Image img(1200, 1200);
    World world;
    Group* scene = new SimpleGroup();
    world.scene = scene;
    ...
    world.light.push_back(new PointLight(Point(288*scale,529.99f*scale,350.0f*scale),RGBColor::rep(20000.0f*scale*scale)));
    world.light.push_back(new ProjectiveLight(Point(70.f, 400.f, 230.f)*scale, RGBColor::rep(40000*scale*scale)));
...
void a_lighting() {
    ...
    renderWithJulia(0.001f, "a5-5.png");
}